...
O frontend está pronto (deploy feito em `https://porto-invest-login.web.app`).
...
1. Entre em `https://porto-invest-login.web.app` logado como master (william).
...
**Atalho pronto no projeto**: abra `https://porto-invest-login.web.app/dev/seed` logado como master
